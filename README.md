...
将以下内容添加到你的 AI 助手的 System Prompt 中，让它智能判断何时触发语音播报：

```
## 任务完成语音提醒

你有语音播报能力。当你完成了实质性工作后，在回复末尾附上总结，触发语音提醒我。
...
规则：
1. 总结内容 100 字以内，自然口语化中文
2. 只说"做了什么、结果如何"，不说技术细节
3. 标记不要放在代码块里，要作为纯文本输出
4. 每次回复最多一条总结，放在最末尾
```
